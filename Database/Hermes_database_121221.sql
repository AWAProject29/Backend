...
INSERT INTO `customer` VALUES (26,NULL,'123123','123','123','$2a$06$BZJfhDrmhsZCXyevcq67o.MMedg4qMjBXBC998VL0vl5GsIZ4nVoq','123'),(27,NULL,'ert','ert','ert','$2a$06$noq5q4.bWFcRukeD2f/iWuV3YhEB15HTejUFZnO6iFDyqueJbUfVS','ert');
...
CREATE TABLE `order` (
  ...
  PRIMARY KEY (`idorder`),
  KEY `fk_idshoppingcart_idx` (`idshoppingcart`),
  CONSTRAINT `fk_idshoppingcart` FOREIGN KEY (`idshoppingcart`) REFERENCES `shoppingcart` (`idshoppingcart`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `restaurant` VALUES (23,NULL,'Name1','Address1','Buffet','€€€','12-24',NULL,'descdescdesc');
...
CREATE TABLE `shoppingcart` (
  ...
  `cartitemname` varchar(45) DEFAULT NULL,
  `cartitemprice` float DEFAULT NULL,
  `cartitemamount` int(11) DEFAULT NULL,
  PRIMARY KEY (`idcartitem`),
  KEY `fk_idshoppingcart` (`idshoppingcart`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `addCustomer`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `addManager`(
	IN firstname VARCHAR(45),
	IN lastname VARCHAR(45),
	IN email VARCHAR(45),
	IN pw VARCHAR(100),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `addProduct`(
    IN productname VARCHAR(45),
	IN productprice FLOAT,
    IN productcategory VARCHAR(45),
    IN productdescription VARCHAR(200),
    IN productimage LONGTEXT,
    IN restaurantpageid INT(11)
)
INSERT INTO product VALUES (productid, productname, productprice, productcategory, productdescription, 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `addRestaurant`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `addToCart`(
    IN idshoppingcart INT(11),
    IN idcartitem INT(11),
    IN cartitemname VARCHAR(45),
    IN cartitemprice FLOAT,
    IN cartitemamount INT(11)
)
INSERT INTO shoppingcart VALUES (idshoppingcart, idcartitem, cartitemname, cartitemprice, cartitemamount); ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `checkAccount`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `removeProduct`(
    IN removedProductId INT(11)
)
DELETE FROM product WHERE productid = removedProductId ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `searchRestaurant`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `showCustomers`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `showManagers`()
BEGIN
    SELECT *  FROM manager;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`b24c114581b63e`@`%` PROCEDURE `showRestaurants`()
BEGIN
